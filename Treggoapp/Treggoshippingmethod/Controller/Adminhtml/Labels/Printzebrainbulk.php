    ...
    public function execute() {
        ...
        if(count($ordersShippingAddresses) > 0) {
            ...
            try {
                ...
                $this->_messageManager->addErrorMessage('Treggo: Se produjo un error en el servidor. Por favor, pongasé en contacto con el administrador de la tienda.');
            ...
            $this->_messageManager->addErrorMessage('No se encontraron etiquetas para imprimir.');
            $resultRedirect = $this->resultRedirectFactory->create();
            $url = $this->_redirect->getRefererUrl();
            $resultRedirect->setUrl($url);
            return $resultRedirect;
